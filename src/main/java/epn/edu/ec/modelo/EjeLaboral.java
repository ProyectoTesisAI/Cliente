...
public class EjeLaboral implements Serializable {
    ...
    private AdolescenteInfractorUDI idEjeLaboral;
    ...
    public AdolescenteInfractorUDI getIdEjeLaboral() {
        return idEjeLaboral;
    }

    public void setIdEjeLaboral(AdolescenteInfractorUDI idEjeLaboral) {
        this.idEjeLaboral = idEjeLaboral;
    }
    ...
    public String toString() {
        return "EjeLaboral{" + "idEjeLaboral=" + idEjeLaboral + ", trabaja=" + trabaja + ", ocupacionAdolescente=" + ocupacionAdolescente + ", ramaActividadEconomica=" + ramaActividadEconomica + ", descripcionActividad=" + descripcionActividad + ", numeroHorasTrabajo=" + numeroHorasTrabajo + ", ingresoMensual=" + ingresoMensual + ", afiliacionIess=" + afiliacionIess + ", inclinacionVocacion=" + inclinacionVocacion + '}';
    }
