...
public class InformacionJudicial implements Serializable {
    ...
    private AdolescenteInfractorUDI idInformacionJudicial;
    ...
    public AdolescenteInfractorUDI getIdInformacionJudicial() {
        return idInformacionJudicial;
    }

    public void setIdInformacionJudicial(AdolescenteInfractorUDI idInformacionJudicial) {
        this.idInformacionJudicial = idInformacionJudicial;
    }
    ...
    public String toString() {
        return "InformacionJudicial{" + "idInformacionJudicial=" + idInformacionJudicial + ", reincidencia=" + reincidencia + ", nombreFiscal=" + nombreFiscal + ", unidadJudicial=" + unidadJudicial + ", nombreJuez=" + nombreJuez + ", defensor=" + defensor + ", nombreDefensor=" + nombreDefensor + ", numeroCausa=" + numeroCausa + ", fechaImposicionMedida=" + fechaImposicionMedida + ", fechaRecepcionZonalResolucion=" + fechaRecepcionZonalResolucion + ", fechaInicioCumplimientoMedida=" + fechaInicioCumplimientoMedida + ", formaImposicionMedida=" + formaImposicionMedida + ", tipoTerminacionAnticipadaMedida=" + tipoTerminacionAnticipadaMedida + ", amonestacionVerbal=" + amonestacionVerbal + ", imposicionReglasConducta=" + imposicionReglasConducta + ", orientacionApoyoSocioFamiliar=" + orientacionApoyoSocioFamiliar + ", servicioComunidad=" + servicioComunidad + ", libertadAsistida=" + libertadAsistida + ", numeroMedidas=" + numeroMedidas + '}';
    }
