...
public class EjecucionMedidaCAI implements Serializable {
    ...
    private AdolescenteInfractorCAI idEjecucionMedida;
    ...
    public AdolescenteInfractorCAI getIdEjecucionMedida() {
        return idEjecucionMedida;
    }

    public void setIdEjecucionMedida(AdolescenteInfractorCAI idEjecucionMedida) {
        this.idEjecucionMedida = idEjecucionMedida;
    }
    ...
    public String toString() {
        return "EjecucionMedidaCAI{" + "idEjecucionMedida=" + idEjecucionMedida + ", fechaAprehension=" + fechaAprehension + ", fechaResolucion=" + fechaResolucion + ", fechaIngresoCai=" + fechaIngresoCai + ", tipoMedida=" + tipoMedida + ", medidaCautelar=" + medidaCautelar + ", alertaSalidaIntermediaPreventiva=" + alertaSalidaIntermediaPreventiva + ", anios=" + anios + ", meses=" + meses + ", dias=" + dias + ", tiempoSentenDias=" + tiempoSentenDias + ", tiempoPrivacionLibertad=" + tiempoPrivacionLibertad + ", observacionesProcesoJudicial=" + observacionesProcesoJudicial + ", idCai=" + idCai + '}';
    }
